    ...
    <section id="contact" className="section contact">
      ...
      <div className="contact-box">
        <p className="contact-text">
          For research partnerships, open-source collaboration, or full-stack AI projects — reach out via
          email or GitHub.
        </p>
        <a href={`mailto:${profile.email}`} className="contact-email">
          {profile.email}
        </a>
        <a href={profile.github} className="contact-github" target="_blank" rel="noreferrer">
          github.com/HDU-Link
        </a>
